  ...
  return (
    <form onSubmit={sympyCalculation} className='m-0 p-0'>
      <div className=''>
        <button
          type='submit'
          className='bg-dark_2 w-36 font-main text-xs py-2 mx-2 font-bold text-light translate-y-1 rounded-t-lg shadow-sm shadow-gray-500 self-center  my-1 active:activeFactor'
        >
            {symbol}
        </button>
      </div>
